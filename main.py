...
# Simple DQN implementation for Google Colab

# Install required packages with alternative Box2D installation
# pip install torch torchvision matplotlib numpy
# pip install gymnasium
# pip install box2d-py
# pip install gymnasium[box2d]

# Alternative: If Box2D still fails, try this simpler version
# !pip install gymnasium torch matplotlib numpy
# Then use CartPole instead of LunarLander
...
# Check if LunarLander is available, fallback to CartPole
try:
